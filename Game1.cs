...
namespace DungeonCrawler
{
    ...
    public class Game1 : Game
    {
        ...
        Texture2D monWalkDown;
        Texture2D monWalkRight;
        Texture2D monWalkLeft;
        Texture2D monWalkUp;
        ...
        public Vector2 monDoor = new Vector2(1088, 320);
        ...
        protected override void LoadContent()
        {
            ...
            //monster
            monWalkDown = Content.Load<Texture2D>("./assets/monster/monsterDown");
            monWalkRight = Content.Load<Texture2D>("./assets/monster/monsterRight");
            monWalkLeft = Content.Load<Texture2D>("./assets/monster/monsterLeft");
            monWalkUp = Content.Load<Texture2D>("./assets/monster/monsterUp");
            ...
            monster.monAnimations[0] = new SpriteAnimation(monWalkDown, 3, 8);
            monster.monAnimations[1] = new SpriteAnimation(monWalkRight, 3, 8);
            monster.monAnimations[2] = new SpriteAnimation(monWalkLeft, 3, 8);
            monster.monAnimations[3] = new SpriteAnimation(monWalkUp, 3, 8);

            monster.anim = monster.monAnimations[0];
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if(gameStarted)
            {
                ...
                if(currentLevel < 15)
                {
                    if(monster.MonsterLevel != currentLevel)
                    {
                        monster.monLevel(round, player, currentLevel);
                    }else
                    {
                        monster.MoveMonster(currentLevel, monDoor, round, gameTime);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            */
            ...
            if (monster.MonsterLevel == currentLevel)
            {
                monster.anim.Draw(_spriteBatch);
            }
            ...
            _spriteBatch.DrawString(gameFont, ""+ monster.MonsterLevel, new Vector2(100, 300), Color.White);
            _spriteBatch.DrawString(gameFont, "playerround" + round, new Vector2(500, 400), Color.White);
            _spriteBatch.DrawString(gameFont, "Monsterrounbd" + monster.monsterRound, new Vector2(100, 400), Color.White);
